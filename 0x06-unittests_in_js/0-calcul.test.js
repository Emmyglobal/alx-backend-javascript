...
describe('calculateNumber', () => {
	describe('Both numbers rounded', () => {
	 ...
	 describe('First number rounded', () => {
                it('should return 4 when a is 1.4 and b is 2', () => {
                        assert.strictEqual(calculateNumber(1.4, 2), 4);
                });
                it('should return 5 when a is 1.5 and b is 2', () => {
                        assert.strictEqual(calculateNumber(1.5, 2), 5);
                });
                ...
                it('should return -3 when a is -1.5 and b is -1', () => {
                        assert.strictEqual(calculateNumber(-1.5, -1), -3);
                });
        });

	 describe('Second number rounded', () => {
                it('should return 4 when a is 2 and b is 1.4', () => {
                        assert.strictEqual(calculateNumber(2, 1.4), 4);
                });
                it('should return 5 when a is 2 and b is 1.5', () => {
                        assert.strictEqual(calculateNumber(2, 1.5), 5);
                });
                ...
                it('should return -3 when a is -1 and b is -1.5', () => {
